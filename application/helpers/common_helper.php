...
if (!function_exists('has_permission')) {
  function has_permission($class_id = "", $section_id = "",  $module = "", $subject_id = "")
  {
    $CI = &get_instance();
    $CI->load->database();
    ...
    $school_id = school_id();
    $permission_details = $CI->db->get_where('teacher_permissions', array('class_id' => $class_id, 'section_id' => $section_id, 'teacher_id' => $teacher_id, 'subject_id' => $subject_id));
